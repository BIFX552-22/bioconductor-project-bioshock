...
We're a little bit uncertain about our workflow. It's terrifyingly long and we aren't quite sure where to start, but here is the link so we don't forget: <https://bioconductor.org/packages/release/workflows/html/methylationArrayAnalysis.html>. We should include some information about the context of this package, such as the types of research it could assist and how it would be used. Some background information on what type of data to feed into the workflow and how it is structured would also be handy.

## 1.2 Loading the Workflow Package

The is the initial step we do to get the methlation array package installed.
...
Now we make MDS plots to help visualize our data and understand its distribution better.
...
It is typical to remove poor quality probes prior to analysis.
...
This helps us do a pair-wise comparison of methylation probes in different cell types. I think.
...
To learn more about other nearby regions, we need to take a more broad view of the data. Or something.
...
There are some extra packages that help us focus in on our region of interest. I hope.
